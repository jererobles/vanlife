...
const I18N = {
  en: {
    ...
    // tip jar
    tipBtn: "treat us",
    tipTitle: "🫙 the treat jar",
    tipSub: "a tip jar with a twist",
    tipPromise: "pick a treat and we'll <b>actually go buy it</b>, wherever the van happens to be that day — then post a polaroid of it to the album with your name on it 💌",
    tipNote: "psst — leave your name in the payment note so we know who to thank!",
    t_coffee: "a roadside coffee",
    t_icecream: "an ice cream by the sea",
    t_beer: "a cold one at camp",
    t_pastry: "breakfast pastries",
    t_picnic: "a picnic feast",
    t_diesel: "a splash of diesel",
    t_sauna: "a sauna night",
    // weather words
  ...
  es: {
    ...
    tipBtn: "invítanos",
    tipTitle: "🫙 el bote de caprichos",
    tipSub: "una propina con truco",
    tipPromise: "elige un capricho y lo <b>compraremos de verdad</b>, esté donde esté la furgo ese día — y subiremos al álbum una polaroid con tu nombre 💌",
    tipNote: "psst — deja tu nombre en la nota del pago, ¡así sabemos a quién dar las gracias!",
    t_coffee: "un café de carretera",
    t_icecream: "un helado junto al mar",
    t_beer: "una cervecita en el camping",
    t_pastry: "bollería para desayunar",
    t_picnic: "un festín de picnic",
    t_diesel: "un chorrito de diésel",
    t_sauna: "una noche de sauna",
    ...
    tipBtn: "tarjoa meille",
    tipTitle: "🫙 herkkupurkki",
    tipSub: "tippipurkki pienellä twistillä",
    tipPromise: "valitse herkku, niin <b>ostamme sen ihan oikeasti</b> siellä missä paku sinä päivänä sattuu olemaan — ja lisäämme albumiin polaroidin, jossa lukee nimesi 💌",
    tipNote: "psst — jätä nimesi maksun viestiin, niin tiedämme ketä kiittää!",
    t_coffee: "tienvarsikahvi",
    t_icecream: "jäätelö meren rannalla",
    t_beer: "yksi kylmä leirissä",
    t_pastry: "aamupalapullat",
    t_picnic: "piknik-herkut",
    t_diesel: "tilkka dieseliä",
    t_sauna: "saunailta",
