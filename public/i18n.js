...
const I18N = {
  en: {
    ...
    statsBtn: "trip stats",
    playBtn: "replay the whole trip",
    replayChip: "🚐 day {n} · {d}",
    startPop: "where it all began",
    endPop: "the journey's end",
    endedNote: "the adventure is complete 🏁",
    ...
    importLinkAdd: "🧵 or stitch points by hand",
    // stitcher
    addTitle: "🧵 stitch the route",
    addSub: "The tracker naps sometimes. Tap the map where the van really went and those spots become route points — each one just needs to know <b>when</b> you were there. A time is guessed from the surrounding route; nudge it if it's off, and drag a marker to fine-tune its spot.",
    addLinkImport: "🧳 got photos from the gap? use the time machine",
    addHint: "tap the map to drop your first point ✨",
    newPoints_1: "1 new point — drag it, or tap the map for more",
    newPoints: "{n} new points — drag them, or tap the map for more",
    whenHere: "when were we here?",
    removePoint: "remove this point",
    addBtn: "✨ stitch these into the route",
    needTime: "🕰 every point needs its moment first",
    futureTime: "🔮 no points from the future, sorry",
    loadFail: "🌫️ couldn't load the route — try refreshing?",
  },
  ...
  es: {
    ...
    stayTitle: "aquí pasamos la noche 💤",
    nights_1: "1 noche",
    nights: "{n} noches",
    ...
    playBtn: "revivir todo el viaje",
    replayChip: "🚐 día {n} · {d}",
    startPop: "donde empezó todo",
    endPop: "el final del viaje",
    endedNote: "la aventura está completa 🏁",
    ...
    importLinkAdd: "🧵 o cose puntos a mano",
    addTitle: "🧵 remendar la ruta",
    addSub: "El tracker a veces se echa la siesta. Toca el mapa por donde pasó la furgo de verdad y esos lugares se vuelven puntos de la ruta — cada uno solo necesita saber <b>cuándo</b> estuviste allí. La hora se adivina a partir de la ruta; ajústala si no cuadra, y arrastra un marcador para afinar su sitio.",
    addLinkImport: "🧳 ¿tienes fotos de ese hueco? usa la máquina del tiempo",
    addHint: "toca el mapa para soltar tu primer punto ✨",
    newPoints_1: "1 punto nuevo — arrástralo, o toca el mapa para más",
    newPoints: "{n} puntos nuevos — arrástralos, o toca el mapa para más",
    whenHere: "¿cuándo estuvimos aquí?",
    removePoint: "quitar este punto",
    addBtn: "✨ coser estos a la ruta",
    needTime: "🕰 cada punto necesita primero su momento",
    futureTime: "🔮 nada de puntos del futuro, lo siento",
    loadFail: "🌫️ no se pudo cargar la ruta — ¿recargas?",
  },
    ...
    playBtn: "katso koko reissu uudestaan",
    replayChip: "🚐 päivä {n} · {d}",
    startPop: "täältä kaikki alkoi",
    endPop: "matkan pää",
    endedNote: "seikkailu on paketissa 🏁",
    ...
    importLinkAdd: "🧵 tai parsi pisteet käsin",
    addTitle: "🧵 reitin parsinta",
    addSub: "Trackeri ottaa joskus nokoset. Napauta karttaa siitä, mistä paku oikeasti meni, niin kohdista tulee reittipisteitä — jokainen tarvitsee vain tiedon siitä, <b>milloin</b> siellä oltiin. Aika arvataan ympäröivästä reitistä; säädä jos se menee pieleen, ja hienosäädä paikkaa raahaamalla merkkiä.",
    addLinkImport: "🧳 onko kuvia siltä väliltä? käytä aikakonetta",
    addHint: "napauta karttaa ja pudota ensimmäinen piste ✨",
    newPoints_1: "1 uusi piste — raahaa sitä tai napauta karttaa lisää",
    newPoints: "{n} uutta pistettä — raahaa niitä tai napauta karttaa lisää",
    whenHere: "milloin oltiin täällä?",
    removePoint: "poista tämä piste",
    addBtn: "✨ parsi nämä reitille",
    needTime: "🕰 jokainen piste tarvitsee ensin hetkensä",
    futureTime: "🔮 ei pisteitä tulevaisuudesta, sori",
    loadFail: "🌫️ reitin lataus ei onnistunut — kokeiletko uudestaan?",
  },
};
